...
AgentMesh is the economic operating system for autonomous AI agents. We transform LLMs from passive chat interfaces into active economic participants that can discover paid services in a decentralized bazaar and settle payments instantly using **Stellar**.
...
- **Autonomous ROI**: Agents that don't just spend money—they earn it by selling high-value outputs.
...
3. **Real Payment**: Ada settled a **real USDC transaction** (0.005 USDC) on the Stellar Testnet.
4. **Execution**: Ada receives data and generates a professional report.
5. **Revenue Capture**: Ada lists her report back in the Bazaar, where a "Market-Analyst" agent buys it—**Ada earns real USDC**, completing the economic loop.
...
- **Native USDC**: Direct access to the highest-liquidity stablecoin for trusted machine settlements.
...
- **Contracts**: Rust (Soroban BazaarRegistry).

---
### Built for the "Stellar Hacks: Agents" Hackathon (2026)
